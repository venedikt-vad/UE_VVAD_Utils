...
public:
    ...
    UFUNCTION(BlueprintPure, Category = "Math|Float", meta = ( DisplayName = "(float) 1-x", KeyWords = ""))
    ...
    UFUNCTION(BlueprintCallable, Category = "Math|Float", meta = (DisplayName = "(float) -= ", KeyWords = "float subtract"))
